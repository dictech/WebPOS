...
<body>
 ...
 <span class="animated zoomIn delay-1s" id="passwordIcon-login"><i class="fas fa-key  fa-1x" ></i></span>
  ...
  <img alt="title-logo" src="images/posv2SingleLogo.png" width="105" height="102">
   ...
   <div>
   <input type="text" name="userName" class="form-inputs-login" placeholder="Username">               
   </div>
  
   <div>
   <input type="password" name="password" class="form-inputs-login" placeholder="Password">               
   </div>    
